...
object DiscordRPC {
    private val ipcClient = IPCClient(1412443250064625785)
    private val timestamp = OffsetDateTime.now()
    private var running = false
    private var fdpwebsite = "SOON"
    ...
    private fun update() {
        ...
        builder.setLargeImage("logo", "Wave+++")
        builder.setDetails("" + FDPClient.CLIENT_VERSION)
