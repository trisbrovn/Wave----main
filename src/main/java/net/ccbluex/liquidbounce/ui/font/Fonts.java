...
public class Fonts {
    ...
    // ----------------------------------------------------------------------
    // --- NEW FONTS ADDED (Verdana, Arial, ESP) with sizes 30, 35, and 40 ---
    // ----------------------------------------------------------------------

    // Verdana
    @FontDetails(fontName = "Verdana", fontSize = 30, fileName = "Verdana.ttf")
    public static GameFontRenderer fontVerdana30;
    @FontDetails(fontName = "Verdana", fontSize = 35, fileName = "Verdana.ttf")
    public static GameFontRenderer fontVerdana35;
    @FontDetails(fontName = "Verdana", fontSize = 40, fileName = "Verdana.ttf")
    public static GameFontRenderer fontVerdana40;
    
    // Verdana-Bold
    @FontDetails(fontName = "Verdana Bold", fontSize = 30, fileName = "Verdana-Bold.ttf")
    public static GameFontRenderer fontVerdanaBold30;
    @FontDetails(fontName = "Verdana Bold", fontSize = 35, fileName = "Verdana-Bold.ttf")
    public static GameFontRenderer fontVerdanaBold35;
    @FontDetails(fontName = "Verdana Bold", fontSize = 40, fileName = "Verdana-Bold.ttf")
    public static GameFontRenderer fontVerdanaBold40;

    // Arial
    @FontDetails(fontName = "Arial", fontSize = 30, fileName = "arial.ttf")
    public static GameFontRenderer fontArial30;
    @FontDetails(fontName = "Arial", fontSize = 35, fileName = "arial.ttf")
    public static GameFontRenderer fontArial35;
    @FontDetails(fontName = "Arial", fontSize = 40, fileName = "arial.ttf")
    public static GameFontRenderer fontArial40;
    
    // Arial-Bold
    @FontDetails(fontName = "Arial Bold", fontSize = 30, fileName = "arial_bold.ttf")
    public static GameFontRenderer fontArialBold30;
    @FontDetails(fontName = "Arial Bold", fontSize = 35, fileName = "arial_bold.ttf")
    public static GameFontRenderer fontArialBold35;
    @FontDetails(fontName = "Arial Bold", fontSize = 40, fileName = "arial_bold.ttf")
    public static GameFontRenderer fontArialBold40;

    // ESP
    @FontDetails(fontName = "ESP", fontSize = 30, fileName = "esp.ttf")
    public static GameFontRenderer fontESP30;
    @FontDetails(fontName = "ESP", fontSize = 35, fileName = "esp.ttf")
    public static GameFontRenderer fontESP35;
    @FontDetails(fontName = "ESP", fontSize = 40, fileName = "esp.ttf")
    public static GameFontRenderer fontESP40;

    // ESP-Bold
    @FontDetails(fontName = "ESP Bold", fontSize = 30, fileName = "esp_bold.ttf")
    public static GameFontRenderer fontESPBold30;
    @FontDetails(fontName = "ESP Bold", fontSize = 35, fileName = "esp_bold.ttf")
    public static GameFontRenderer fontESPBold35;
    @FontDetails(fontName = "ESP Bold", fontSize = 40, fileName = "esp_bold.ttf")
    public static GameFontRenderer fontESPBold40;
    
    // Roboto Regular
    @FontDetails(fontName = "Roboto", fontSize = 30, fileName = "roboto.ttf")
    public static GameFontRenderer fontRoboto30;
    @FontDetails(fontName = "Roboto", fontSize = 35, fileName = "roboto.ttf")
    public static GameFontRenderer fontRoboto35;
    @FontDetails(fontName = "Roboto", fontSize = 40, fileName = "roboto.ttf")
    public static GameFontRenderer fontRoboto40;
    
    // Comfortaa Regular
    @FontDetails(fontName = "Comfortaa", fontSize = 30, fileName = "Comfortaa.ttf")
    public static GameFontRenderer fontComfortaa30;
    @FontDetails(fontName = "Comfortaa", fontSize = 35, fileName = "Comfortaa.ttf")
    public static GameFontRenderer fontComfortaa35;
    @FontDetails(fontName = "Comfortaa", fontSize = 40, fileName = "Comfortaa.ttf")
    ...
    public static void loadFonts() {
        ...
        // Existing manual initializations (Keep them for compatibility)
        ...
        // 1. Initialize and unpack all font files
        initFonts();

        // 2. Automatic initialization for fields with a fileName specified in @FontDetails
    ...
    // ----------------------------------------------------------------------
    // --- UPDATED initFonts() to unpack new font files ---
    // ----------------------------------------------------------------------
    private static void initFonts() {
        try {
            initSingleFont("regular.ttf", "assets/minecraft/fdpclient/font/regular.ttf");
            
            // Unpack files from the image
            initSingleFont("arial_bold.ttf", "assets/minecraft/fdpclient/font/arial_bold.ttf");
            initSingleFont("arial.ttf", "assets/minecraft/fdpclient/font/arial.ttf");
            initSingleFont("esp_bold.ttf", "assets/minecraft/fdpclient/font/esp_bold.ttf");
            initSingleFont("esp.ttf", "assets/minecraft/fdpclient/font/esp.ttf");
            initSingleFont("Verdana-Bold.ttf", "assets/minecraft/fdpclient/font/Verdana-Bold.ttf");
            initSingleFont("Verdana.ttf", "assets/minecraft/fdpclient/font/Verdana.ttf");
            
            // Added Roboto.ttf unpacking
            initSingleFont("roboto.ttf", "assets/minecraft/fdpclient/font/roboto.ttf");

            // Added Comfortaa.ttf unpacking
