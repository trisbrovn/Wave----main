...
object FDPClient {
    ...
    // Client information
    const val CLIENT_NAME = "Wave+++"
    const val COLORED_NAME = "§7[§b§lWave+++§7] "
    const val CLIENT_CREATOR = "tris_bro"
    const val CLIENT_WEBSITE = "Private"
    const val CLIENT_VERSION = "v2.0.0"
